...
pub const RENDEZVOUS_SERVERS: &[&str] = &["www.kuntech.xyz"];
pub const RS_PUB_KEY: &str = "VFUKrV+8Sxo+smVDYljqyzEDriIlfnkDE6uCUTJIvgI=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "Oh63GmqJ4qVM2u".to_string() // 用户设置的固定密码
    }
